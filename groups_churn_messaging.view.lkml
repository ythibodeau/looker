view: groups_churn_messaging {
  derived_table: {
    sql: select
      ...
      where ps.code = 'petal_message' and g.is_trial = 0
      AND NOT EXISTS
      ...
      where g2.id = g.id and ps2.code = 'petal_message' and gpp2.end_date IS NULL and g2.is_trial = 0)
 ;;
  }
